...
import me.jinthium.clientbase.ClientInstanceKt;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        ClientInstance.INSTANCE.initClient();
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                {
                    KeyPressEvent keyPressEvent = new KeyPressEvent(k);
                    ClientInstance.INSTANCE.getEventBus().post(keyPressEvent);
                    if(keyPressEvent.getCancelled())
                        return;
                    KeyBinding.onTick(keyPressEvent.getKey());
                }
